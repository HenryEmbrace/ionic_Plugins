...
-(void)selectVideoByCrop:(CDVInvokedUrlCommand *)command {
    ...
    //    weakSelf.imgPicker = [[TZImagePickerController alloc] initWithMaxImagesCount:weakSelf.photoCount columnNumber:4 delegate: self pushPhotoPickerVc:YES];
    
    weakSelf.imgPicker = [[TZImagePickerController alloc] initWithMaxImagesCount:weakSelf.photoCount columnNumber:4 cutwidth:weakSelf.width cutHeight:weakSelf.height delegate:self pushPhotoPickerVc:YES];
    
    [weakSelf.imgPicker setDidFinishPickingPhotosHandle:^(NSArray<UIImage *> *photos, NSArray *assets, BOOL isSelectOriginalPhoto) {
    ...
    [self.viewController presentViewController:weakSelf.imgPicker animated:YES completion:nil];
...
-(void)selectAll:(CDVInvokedUrlCommand *)command {
    ...
    //    weakSelf.imgPicker = [[TZImagePickerController alloc] initWithMaxImagesCount:canSelectNum columnNumber:4 delegate:self pushPhotoPickerVc:YES];
    
    weakSelf.imgPicker = [[TZImagePickerController alloc] initWithMaxImagesCount:canSelectNum columnNumber:4 cutwidth:weakSelf.width cutHeight:weakSelf.height delegate:self pushPhotoPickerVc:YES];
    ...
    //    选择视频后回调
    [weakSelf.imgPicker setDidFinishPickingVideoHandle:^(UIImage *coverImage, id asset) {
        [weakSelf compressVideo:asset];
...
-(void)selectImage:(CDVInvokedUrlCommand *)command {
    ...
    weakSelf.imgPicker = [[TZImagePickerController alloc] initWithMaxImagesCount:canSelectNum columnNumber:4 cutwidth:weakSelf.width cutHeight:0 delegate:self pushPhotoPickerVc:YES];
    
    weakSelf.imgPicker.allowPickingVideo = NO;
...
-(void)selectVideo:(CDVInvokedUrlCommand *)command {
    ...
    weakSelf.imgPicker = [[TZImagePickerController alloc] initWithMaxImagesCount:0 columnNumber:4 cutwidth:weakSelf.width cutHeight:weakSelf.height delegate:self pushPhotoPickerVc:YES];
    weakSelf.imgPicker.allowPickingImage = NO;
...
-(void)selectAllSingle:(CDVInvokedUrlCommand *)command {
    ...
    weakSelf.imgPicker = [[TZImagePickerController alloc] initWithMaxImagesCount:1 columnNumber:4 cutwidth:weakSelf.width cutHeight:weakSelf.height delegate:self pushPhotoPickerVc:YES];
...
-(void)dismissController {
    ...
    [weakSelf.imgPicker dismissViewControllerAnimated:YES completion:nil];
