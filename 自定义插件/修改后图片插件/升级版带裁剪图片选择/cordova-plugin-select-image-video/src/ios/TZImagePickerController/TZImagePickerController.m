...
- (instancetype)initWithMaxImagesCount:(NSInteger)maxImagesCount columnNumber:(NSInteger)columnNumber  cutwidth:(NSInteger)cutWidth cutHeight:(NSInteger) cutHieight delegate:(id<TZImagePickerControllerDelegate>)delegate pushPhotoPickerVc:(BOOL)pushPhotoPickerVc {
...
- (void)configDefaultSetting {
    ...
    self.cropRect = CGRectMake(0, (self.view.tz_height - cropViewWH) / 2, cropViewWH, cropViewWH);
}
