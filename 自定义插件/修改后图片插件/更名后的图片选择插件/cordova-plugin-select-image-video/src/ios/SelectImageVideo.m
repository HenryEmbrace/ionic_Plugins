...
-(void)selectVideoByCrop:(CDVInvokedUrlCommand *)command {
    ...
    //    weakSelf.imgPicker = [[BYImagePickerController alloc] initWithMaxImagesCount:weakSelf.photoCount columnNumber:4 delegate: self pushPhotoPickerVc:YES];
    
    weakSelf.imgPicker = [[BYImagePickerController alloc] initWithMaxImagesCount:weakSelf.photoCount columnNumber:4 cutwidth:weakSelf.width cutHeight:weakSelf.height delegate:self pushPhotoPickerVc:YES];
...
-(void)selectAll:(CDVInvokedUrlCommand *)command {
    ...
    //    weakSelf.imgPicker = [[BYImagePickerController alloc] initWithMaxImagesCount:canSelectNum columnNumber:4 delegate:self pushPhotoPickerVc:YES];
    
    weakSelf.imgPicker = [[BYImagePickerController alloc] initWithMaxImagesCount:canSelectNum columnNumber:4 cutwidth:weakSelf.width cutHeight:weakSelf.height delegate:self pushPhotoPickerVc:YES];
...
-(void)selectImage:(CDVInvokedUrlCommand *)command {
    ...
    weakSelf.imgPicker = [[BYImagePickerController alloc] initWithMaxImagesCount:canSelectNum columnNumber:4 cutwidth:weakSelf.width cutHeight:0 delegate:self pushPhotoPickerVc:YES];
...
-(void)selectVideo:(CDVInvokedUrlCommand *)command {
    ...
    weakSelf.imgPicker = [[BYImagePickerController alloc] initWithMaxImagesCount:0 columnNumber:4 cutwidth:weakSelf.width cutHeight:weakSelf.height delegate:self pushPhotoPickerVc:YES];
...
-(void)selectAllSingle:(CDVInvokedUrlCommand *)command {
    ...
    weakSelf.imgPicker = [[BYImagePickerController alloc] initWithMaxImagesCount:1 columnNumber:4 cutwidth:weakSelf.width cutHeight:weakSelf.height delegate:self pushPhotoPickerVc:YES];
