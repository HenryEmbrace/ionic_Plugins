...
@interface BYGifPhotoPreviewController () {
    UIView *_toolBar;
    UIButton *_doneButton;
    UIProgressView *_progress;
    
    BYPhotoPreviewView *_previewView;
    
    UIStatusBarStyle _originStatusBarStyle;
}
    @end

@implementation BYGifPhotoPreviewController
...
- (void)viewDidLoad {
    ...
    if (BYImagePickerVc) {
        self.navigationItem.title = [NSString stringWithFormat:@"GIF %@",BYImagePickerVc.previewBtnTitleStr];
    }
...
- (void)configBottomToolBar {
    ...
    [[BYImageManager manager] getPhotosBytesWithArray:@[_model] completion:^(NSString *totalBytes) {
