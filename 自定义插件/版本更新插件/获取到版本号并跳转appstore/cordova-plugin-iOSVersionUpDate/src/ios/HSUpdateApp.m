...
+(void)hs_updateWithAPPID:(NSString *)appid currentVersion:(NSString *)currentVersion block:(void(^)(NSString *currentVersion,NSString *storeVersion, NSString *openUrl,BOOL isUpdate))block{
    //1先获取当前工程项目版本号
